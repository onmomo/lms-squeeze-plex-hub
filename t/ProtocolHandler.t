...
'http://example:32400/library/parts/1/file.flac?X-Plex-Token=abc&squeezePlexHub_rk=57038&foo=1';
    my $r = Plugins::SqueezePlexHub::ProtocolHandler::_parse_stream_url($u);
...
{
    reset_state();
    my $t = Plugins::SqueezePlexHub::ProtocolHandler::_compose_title(
        {
            artist => 'Linkin Park',
            title  => 'H! Vltg3',
        }
    ...
    my $t2 = Plugins::SqueezePlexHub::ProtocolHandler::_compose_title(
        {
            title => 'Only Title',
        }
    );
...
'http://pms:32400/library/parts/1/file.flac?X-Plex-Token=abc&squeezePlexHub_rk=57038';
    my $returned;
    Plugins::SqueezePlexHub::ProtocolHandler->explodePlaylist( $client, $uri,
        sub { $returned = shift } );
...
XML
    ...
    my $got;
    Plugins::SqueezePlexHub::ProtocolHandler::_fetch_plex_track_metadata(
        sub { $got = shift },
